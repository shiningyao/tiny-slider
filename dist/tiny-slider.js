(function (global, factory) {
    ...
    var tns = function(options) {
      ...
      var supportConsoleWarn = win$1.console && typeof win$1.console.warn === "function";
      ...
      function getWindowWidth () {
        return win$1.innerWidth || doc.documentElement.clientWidth || doc.body.clientWidth;
      }
      ...
      (function sliderInit () {
        ...
        if (carousel && horizontal) {
          ...
          if (SUBPIXEL) {
            ...
            addCSSRule(sheet, '#' + slideId + ' > .tns-item', 'font-size:' + win$1.getComputedStyle(slideItems[0]).fontSize + ';', getCssRulesLength(sheet));
        ...
        if (nested === 'inner') {
          ...
          addEvents(win$1, {'resize': onResize});
        }
    ...
    // === ON RESIZE ===
      function onResize (e) {
        raf(function(){ resizeTasks(e || win$1.event); });
      }
      ...
      function getTarget (e) {
        return e.target || win$1.event.srcElement;
      }
      ...
      return {
        ...
        destroy: function () {
          ...
          removeEvents(win$1, {'resize': onResize});
